...
export class UsersController {
  ...
  static async handleUsers(...args) {
    return await handleUsers(...args);
  }

  static async resetUserPassword(...args) {
    return await resetUserPassword(...args);
  }

  static async handleTeachers(...args) {
    return await handleTeachers(...args);
  }

  static async handleAcudientes(...args) {
    return await handleAcudientes(...args);
  }
  ...
  static async recoverPassword(...args) {
    return await recoverPassword(...args);
  }
