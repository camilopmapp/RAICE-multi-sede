...
export class ConfigController {
  static async handleConfig(...args) {
    return await handleConfig(...args);
  }

  static async handleRealtimeConfig(...args) {
    return await handleRealtimeConfig(...args);
  }

  static async handleSecurityConfig(...args) {
    return await handleSecurityConfig(...args);
  }

  static async handleLogs(...args) {
    return await handleLogs(...args);
  }

  static async handlePeriods(...args) {
    return await handlePeriods(...args);
  }

  static async handleBellSchedule(...args) {
    return await handleBellSchedule(...args);
  }

  static async handleFaltasCatalogo(...args) {
    return await handleFaltasCatalogo(...args);
  }

  static async handleTipo1Escalones(...args) {
    return await handleTipo1Escalones(...args);
  }

  static async syncPeriods(...args) {
    return await syncPeriods(...args);
  }

  static async handleYearRollover(...args) {
    return await handleYearRollover(...args);
  }
