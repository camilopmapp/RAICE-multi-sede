...
export class CoursesController {
  static async function handleCourses(req, res, user) {
  ...
  static async function handleSubgroupMembers(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb  = getSupabase();
  ...
  static async function getMyCourses(req, res, user) {
  const sb    = getSupabase();
  const today  = todayCO();
  ...
  static async function handleTeacherCourses(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb = getSupabase();
