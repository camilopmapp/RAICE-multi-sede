...
export class AlertsController {
  static async function getAlerts(sb) {
  const alerts = [];
  const today = todayCO();
  ...
  static async function getAlertsEndpoint(req, res, user) {
  ...
  static async function handleNotifications(req, res, user) {
  const sb = getSupabase();
  if (req.method === 'GET') {
    try {
  ...
  static async function sendNotification(sb, toUserId, fromUserId, type, title, body, linkId = null) {
  ...
  static async function handleCitations(req, res, user) {
  ...
  static async function handleCalendar(req, res, user) {
  const sb = getSupabase();
  ...
  static async function handleCalendarRange(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  ...
  static async function handleCalendarToday(req, res, user) {
  if (req.method !== 'GET') return res.status(405).end();
  const sb = getSupabase();
  ...
  static async function getEvasions(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
  ...
  static async function resolveEvasion(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  if (req.method !== 'POST') return res.status(405).end();
  const sb = getSupabase();
  ...
  static async function handleClassroomRemovals(req, res, user) {
  const sb = getSupabase();
  ...
  static async function handleSuspensions(req, res, user) {
  const sb = getSupabase();
  ...
  static async function handleExcusas(req, res, user) {
