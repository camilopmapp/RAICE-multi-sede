...
export class AttendanceController {
  static async handleAttendance(...args) {
    return await handleAttendance(...args);
  }

  static async getAttendanceToday(...args) {
    return await getAttendanceToday(...args);
  }

  static async getMissingAttendance(...args) {
    return await getMissingAttendance(...args);
  }

  static async getAttendanceByCourse(...args) {
    return await getAttendanceByCourse(...args);
  }

  static async getAttendanceRange(...args) {
    return await getAttendanceRange(...args);
  }

  static async unlockAttendance(...args) {
    return await unlockAttendance(...args);
  }

  static async cleanupOrphanedPE(...args) {
    return await cleanupOrphanedPE(...args);
  }
