...
export class ReportsController {
  static async function getCasesReport(req, res, user) {
  ...
  static async function getDashboardV2(req, res, user) {
  ...
  static async function getStatsByPeriod(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
  ...
  static async function getTardanzasReport(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb  = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
  ...
  static async function reportAttendance(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb  = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
  ...
  static async function reportCases(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb  = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
  ...
  static async function cronWeeklyReport(req, res) {
  ...
  static async function reportAttendanceV2(req, res, user) {
  requireRole(user, 'superadmin', 'admin');
  const sb  = getSupabase();
  const url = new URL(req.url, `http://${req.headers.host}`);
