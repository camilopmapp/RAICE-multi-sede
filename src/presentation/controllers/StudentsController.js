...
export class StudentsController {
  static async handleStudents(...args) {
    return await handleStudents(...args);
  }

  static async importStudents(...args) {
    return await importStudents(...args);
  }

  static async _createSimatStudent(...args) {
    return await _createSimatStudent(...args);
  }

  static async simatPreview(...args) {
    return await simatPreview(...args);
  }

  static async simatImport(...args) {
    return await simatImport(...args);
  }

  static async getStudentFicha(...args) {
    return await getStudentFicha(...args);
  }

  static async handlePortalAcudiente(...args) {
    return await handlePortalAcudiente(...args);
  }

  static async handleRegisterOmission(...args) {
    return await handleRegisterOmission(...args);
  }

  static normName(...args) {
    return normName(...args);
  }

  static buildStudentRows(...args) {
    return buildStudentRows(...args);
  }

  static async globalSearch(...args) {
