...
export class CasesController {
  static async handleCases(...args) {
    return await handleCases(...args);
  }

  static async getMyCases(...args) {
    return await getMyCases(...args);
  }

  static async getCaseDetail(...args) {
    return await getCaseDetail(...args);
  }

  static async updateCaseStatus(...args) {
    return await updateCaseStatus(...args);
  }

  static async saveCaseFollowup(...args) {
    return await saveCaseFollowup(...args);
  }

  static async handleCommitments(...args) {
    return await handleCommitments(...args);
  }

  static async fulfillCommitment(...args) {
    return await fulfillCommitment(...args);
  }

  static async getStudentHistory(...args) {
    return await getStudentHistory(...args);
  }

  static async getStudentGradeHistory(...args) {
    return await getStudentGradeHistory(...args);
  }

  static async getGradeCases(...args) {
    return await getGradeCases(...args);
  }

  static async handleObservations(...args) {
    return await handleObservations(...args);
  }
